...
UI_TR = {
    ...
    f"gui.{NS}.catalogue": "Araba kataloğu — tıkla, parçalar dizilsin",
    f"gui.{NS}.needs": "Gerekenler:",
    f"message.{NS}.missing_part": "Eksik parça: %s",
    f"message.{NS}.parts_loaded": "Parçalar tezgaha dizildi",
...
UI_EN = {
    ...
    f"gui.{NS}.catalogue": "Car catalogue \u2014 click to load the parts",
    f"gui.{NS}.needs": "Needs:",
    f"message.{NS}.missing_part": "Missing part: %s",
    f"message.{NS}.parts_loaded": "Parts loaded onto the bench",
