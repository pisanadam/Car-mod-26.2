...
UI_TR = {
    ...
    f"gui.{NS}.tab.engine": "Motor ve Şanzıman",
    ...
    f"key.{NS}.category": "RealCars",
    f"key.{NS}.engine_toggle": "Motoru çalıştır/durdur",
    f"key.{NS}.horn": "Korna",
    f"key.{NS}.shift_up": "Vites yükselt",
    f"key.{NS}.shift_down": "Vites düşür",
...
UI_EN = {
    ...
    f"gui.{NS}.tab.engine": "Engine & Gearbox",
    ...
    f"key.{NS}.horn": "Horn",
    f"key.{NS}.shift_up": "Shift up",
    f"key.{NS}.shift_down": "Shift down",
